...
void greeting(); // declaration of greeting(). For function declarations, the `extern` keyword is not mandatory and is usually not used, although it is not wrong. The function header (i.e., the prototype) is enough.
